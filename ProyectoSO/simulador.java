...
public class simulador {
    ...
    int quantum = planificador == null ? 1 : planificador.getQuantum();
        ...
        while (procesosAgregados < procesosPorLlegar.size() || !colaListos.isEmpty() || !colaMemoria.isEmpty()) {
            // Agregar procesos a la cola de listos según tiempo de llegada
            ...
            // Mover procesos de listos a memoria si hay espacio
            ...
            // Ejecutar proceso en memoria (Round Robin)
            if (!colaMemoria.isEmpty()) {
                ...
                // Si no hay procesos en memoria, avanzar el tiempo
                try { Thread.sleep(1000); } catch (InterruptedException e) { }
                tiempoActual++;
    ...
    // Muestra el estado actual de las colas y procesos
